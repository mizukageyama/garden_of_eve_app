...
///  * [Step]
///  * <https://material.io/archive/guidelines/components/steppers.html>
class CutomStepper extends StatefulWidget {
  ...
  @override
  State<CutomStepper> createState() => _CutomStepperState();
}

class _CutomStepperState extends State<CutomStepper>
  ...
  @override
  void didUpdateWidget(CutomStepper oldWidget) {
              ...
              style: ButtonStyle(
                foregroundColor: MaterialStateProperty.resolveWith<Color?>(
                  ...
                  return states.contains(MaterialState.disabled)
                      ? null
                      : (_isDark() ? neutralGreyColor : greenColor);
                }),
